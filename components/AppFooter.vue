    ...
    <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <section class="xl:col-span-1">
          <svg class="h-12 w-12 fill-current text-gray-500" viewBox="0 0 20 20">
          ...
          <h2 class="mt-6 text-gray-600 text-base leading-6">"The surprising styles of Skyline Ivy are advanced for all seasons."</h2>
          <p class="mt-2 text-gray-500 text-base leading-6">Hansel Andersen</p>
          <div class="mt-8 flex">
      ...
      <div class="mt-12 border-t border-gray-300 pt-8">
        <p class="text-base leading-normal text-gray-500 xl:text-center">
          The project is
          <a class="text-indigo-600 font-medium" href="https://github.com/sdras/ecommerce-netlify">open source on github</a>,
          hosted with
          <a class="text-indigo-600 font-medium" href="https://bit.ly/2G29YwK">Netlify</a>, and made with love by Sarah Drasner,
          <a class="text-indigo-600 font-medium" href="https://github.com/sdras">@sdras (github)</a>
        </p>
      </div>
    </div>
  </footer>
